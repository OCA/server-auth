...
base.res.res_users.USER_PRIVATE_FIELDS.append('oauth_access_multi_master_token')
...
class ResUsers(models.Model):
    ...
    oauth_access_multi_master_token = fields.Char(
        string='Master token',
        copy=False,
        readonly=True,
        required=True,
    ...
    def action_oauth_clear_token(self):
        ...
        for res in self.sudo():
            res.oauth_access_multi_master_token = self._generate_unique_uuid()
    ...
    def _get_session_token_fields(self):
        ...
        return res | {'oauth_access_multi_master_token'}
