...
from .arguments import provider, saml_response, validation
...
class TestAuthSamlCreateUser(TestAuthSamlCreateUserCommon):
    ...
    def test_010_auth_saml_signin(self):
        self.ResUsers._auth_saml_signin(provider, validation, saml_response)
    ...
    def test_030_create_user(self):
        ...
        user_ids = self.ResUsers.search([("saml_uid", "=", saml_uid)])
