...
@click.option(
    "--username", prompt="Username", help="Username to authenticate.", default=UID
)
@click.option("--password", prompt="Password", default=PWD)
@click.option(
    "--client_id", prompt="Client ID", help="Keycloak client ID.", default=CLIENT_ID
)
@click.option(
    "--client_secret",
