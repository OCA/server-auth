...
class TestAuthOIDCAuthorizationCodeFlow(common.HttpCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.rsa_key_pem, cls.rsa_key_public_pem, cls.rsa_key_public_jwk =\
            cls._generate_key()
    ...
    def _prepare_login_test_responses(self,
                                      access_token="42",
                                      id_token_body=None,
    ...
    def test_login_without_kid_multiple_keys_in_jwks(self):
        ...
        self._prepare_login_test_responses(
            ...
            keys=[{
                "kid": "other_key_id",
                "keys": [self.second_key_public_pem],
            }, {
                "kid": "the_key_id",
                "keys": [self.rsa_key_public_pem],
            }],
