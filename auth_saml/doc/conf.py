...
htmlhelp_basename = 'SAML2AuthenticationDoc'
...
latex_documents = [
    (master_doc, 'SAML2Authentication.tex',
...
man_pages = [
    (master_doc, 'saml2authentication', u'SAML2 authentication documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SAML2Authentication', u'SAML2 authentication documentation',
     author, 'SAML2Authentication',
     'Let users log into Odoo via an SAML2 provider.', 'Miscellaneous'),
]
