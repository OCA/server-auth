...
class TestOAuthProviderClient(TransactionCase):
    ...
    def test_grant_response_type_mobile_application(self):
        """Check the value of the grant_type and response_type fields"""
        # Mobile Application
        client = self.new_client(vals={"application_type": "mobile application"})
    ...
    def test_grant_response_type_legacy_application(self):
        """Check the value of the grant_type and response_type fields"""
        # Legacy Application
        client = self.new_client(vals={"application_type": "legacy application"})
    ...
    def test_grant_response_type_backend_application(self):
        """Check the value of the grant_type and response_type fields"""
        # Backend Application
        client = self.new_client(vals={"application_type": "backend application"})
    ...
    def test_get_oauth2_server_default(self):
        ...
        client = self.new_client({"identifier": "default"})
        self.assertTrue(
            isinstance(client.get_oauth2_server(), oauth2.WebApplicationServer)
        )
    ...
    def test_get_oauth2_server_mobile_application(self):
        ...
        client = self.new_client(vals={"application_type": "mobile application"})
        self.assertTrue(
            isinstance(client.get_oauth2_server(), oauth2.MobileApplicationServer)
        )
    ...
    def test_get_oauth2_server_legacy_applicaton(self):
        ...
        client = self.new_client(vals={"application_type": "legacy application"})
        self.assertTrue(
            isinstance(client.get_oauth2_server(), oauth2.LegacyApplicationServer)
        )
    ...
    def test_get_oauth2_server_backend_application(self):
        ...
        client = self.new_client(vals={"application_type": "backend application"})
        self.assertTrue(
            isinstance(client.get_oauth2_server(), oauth2.BackendApplicationServer)
        )
    ...
    def test_get_oauth2_server_validator(self):
        ...
        self.assertTrue(
            isinstance(client.get_oauth2_server().request_validator, OdooValidator)
        )
