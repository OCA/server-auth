...
class TestUI(common.HttpCase):
    def setUp(self):
        ...
        self.env.ref("base.user_admin").password = self.admin_password
        self.passkey_password = "PasskeyPa$$w0rd"
        self.passkey_user = self.env["res.users"].create(
            {
                "name": "passkey",
                "login": "passkey",
                "email": "passkey",
    ...
    def test_01_normal_login_admin_succeed(self):
        ...
        self.assertIn(b"oe_login_form", response.data)
        ...
        self.assertNotIn(b"oe_login_form", response.data)
    ...
    def test_02_normal_login_admin_fail(self):
        ...
        self.assertIn(b"Wrong login/password", response.data)
