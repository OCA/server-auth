...
--- | --- | --- | ---
[auth_api_key](auth_api_key/) | 13.0.1.1.0 |  | Authenticate http requests from an API key
...
[vault](vault/) | 13.0.1.0.0 |  | Password vault integration in Odoo
[vault_share](vault_share/) | 13.0.1.0.0 |  | Implementation of a mechanism to share secrets
