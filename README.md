...
[auth_oauth_autologin](auth_oauth_autologin/) | 13.0.1.0.0 | [![sbidoul](https://github.com/sbidoul.png?size=30px)](https://github.com/sbidoul) | Automatically redirect to the OAuth provider for login
