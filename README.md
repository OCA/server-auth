...
[auth_api_key](auth_api_key/) | 14.0.2.2.1 |  | Authenticate http requests from an API key
...
[vault](vault/) | 14.0.1.7.1 |  | Password vault integration in Odoo
[vault_share](vault_share/) | 14.0.1.2.0 |  | Implementation of a mechanism to share secrets
