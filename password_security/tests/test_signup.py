...
class EndTestException(Exception):
    """Permet d'isoler les ressources en levant une exception de test."""
...
class TestPasswordSecuritySignup(HttpCase):
    ...
    def test_01_signup_user_fail(self):
        """Doit échouer avec un mot de passe faible."""
    ...
    def test_03_create_user_signup(self):
        """Le mot de passe est vérifié lors de l'inscription."""
